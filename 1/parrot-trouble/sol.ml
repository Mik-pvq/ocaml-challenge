let parrot_trouble (t:bool) (o:int) = 
  if o < 0 || o > 23 then 
    None
  else if o < 7 && t then 
    Some true
...
assert(parrot_trouble true 3 = Some true);;
assert(parrot_trouble true 4 = Some true);;
...
assert(parrot_trouble true 9 = Some false);;
assert(parrot_trouble true 10 = Some false);;
assert(parrot_trouble true 11 = Some false);;
assert(parrot_trouble true 12 = Some false);;
assert(parrot_trouble true 13 = Some false);;
assert(parrot_trouble true 14 = Some false);;
assert(parrot_trouble true 15 = Some false);;
assert(parrot_trouble true 16 = Some false);;
assert(parrot_trouble true 17 = Some false);;
assert(parrot_trouble true 18 = Some false);;
assert(parrot_trouble true 19 = Some false);;
...
assert(parrot_trouble false 3 = Some false);;
assert(parrot_trouble false 4 = Some false);;
...
assert(parrot_trouble false 11 = Some false);;
assert(parrot_trouble false 12 = Some false);;
assert(parrot_trouble false 13 = Some false);;
assert(parrot_trouble false 14 = Some false);;
assert(parrot_trouble false 15 = Some false);;
assert(parrot_trouble false 16 = Some false);;
assert(parrot_trouble false 17 = Some false);;
assert(parrot_trouble false 18 = Some false);;
assert(parrot_trouble false 19 = Some false);;
